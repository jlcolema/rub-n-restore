...
//create thumb size for wcpr photo reviews 
/*function imgf_register_custom_image_sizes() {
if ( ! current_theme_supports( 'post-thumbnails' ) ) {
add_theme_support( 'post-thumbnails' );
}
add_image_size( 'wcpr-photo-reviews', 500, 0, false );
}
add_action( 'after_setup_theme', 'imgf_register_custom_image_sizes' );*/
...
//Make all imgae sizes avaialble in beaver builder
